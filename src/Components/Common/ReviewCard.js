        ...
        <Container className=''>
            <Row >
                ...
                <Col xs={12} md={4} className=" mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img src={rev1} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                ...
                <Col xs={12} md={4} className=" mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img src={rev3} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                ...
                <Col xs={12} md={4} className=" mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img src={rev2} alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
