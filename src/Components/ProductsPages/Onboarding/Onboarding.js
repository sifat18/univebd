        ...
        <>
            ...
            <Container className='my-5'>
                <section className='text-center '>
                    ...
                    <div >
                        <img className='img-fluid w-50' src={onb0} alt="" />

                    </div>
                    <img className='img-fluid  w-75 my-5' src={onb1} alt="" />
            ...
            <Container fluid className='text-center py-5 middle'>
                <Container className='my-5 w-75'>
                    <div className="bg-white mx-auto py-4 w-50 my-5 rounded-pill d-flex justify-content-around">
                        ...
                        <Button onClick={() => handleOnb('up')} variant="outline-light onbButton  py-3 px-5 rounded-pill ">Upskill</Button>
                        <Button onClick={() => handleOnb('retain')} variant="outline-light onbButton  py-3 px-5 rounded-pill">Retain</Button>
                    </div>
