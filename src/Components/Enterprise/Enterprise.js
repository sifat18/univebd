                    ...
                    <Row className='my-5'>
                        ...
                        <Col xs={12} md={6}>
                            ...
                            <div className="text-start">
                                <p><BsCheck2Circle className='text-success fs-4 me-2' /> সম্পূর্ণ পার্সোনালাইজড জাস্ট ইন টাইম লার্নিং এর সুবিধা।</p>
            ...
            <Container data-aos="fade-left">
                <Row>
                    <Col xs={12} md={6}>
                        ...
                        <div className="text-start">
                            <p><BsCheck2Circle className='text-success fs-4 me-2' /> মনিটর করুন টীম বা যেকোনো এমপ্লয়ী এর প্রগ্রেস</p>
                ...
                <section className='container mt-5'>
                    <Row className='my-5'>
                        ...
                        <Col xs={12} md={6}>
                            ...
                            <div className="text-start">
                                <p><BsCheck2Circle className='text-success fs-4 me-2' />শিখুন অফলাইনে</p>
            ...
            <Container data-aos="fade-left">
                <Row>
                    <Col xs={12} md={6}>
                        ...
                        <div className="text-start">
                            <p><BsCheck2Circle className='text-success fs-4 me-2' />অন দি গো আইটি ট্রেইনিং</p>
