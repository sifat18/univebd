...
export default function EnterPriseTerm() {
    return (
        <Container>
            ...
            <p className="fw-bold">Organization Data</p>
            <p>If you are using the Service through your organization (employer, school, etc.), your organization will be able to see information about you including, without limitation, your name, your progress on courses, and information about your activities using the Service. Contact your organization’s administrator if you have any questions about what information they can see and what they are able to do with it.</p>
