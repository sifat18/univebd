    ...
    return (
        <>
            <Header /><Container>
                ...
                <p>Effective August 23, 2021</p>
                <p>These Terms of Service (“Terms”) constitute a binding contract between you (“you” or “Customer”) and Educative, Inc. (“us” or “we” or “Educative”) governing the use of and access to the products we offer in connection with a paid or trial subscription (“Educative Service”) to you and any authorized individuals engaged by you to use the Educative Service on your behalf (each, a “User,” and collectively, “Users”). By using or accessing the Educative Service or authorizing or permitting any User to use or access the Educative Service, you accept and agree to be bound by these Terms.</p>
                <p>We may update these Terms from time to time. If we do, we will update the Effective Date listed above. Your continued use of the Educative Service after these Terms have changed will constitute your agreement to the modified Terms. If you do not agree to the modified Terms, your only recourse is to terminate your use of the Educative Service.</p>
                <p className='fw-bold'> 1. Definitions.</p>
                <p><span className="fw-bold">“Course Content”</span> means all intellectual property and rights including coursework, images, sounds, and video owned or licensed by Educative and provided through the Educative Service.</p>
                <p><span className="fw-bold">“Customer Content”</span>  means all intellectual property and rights including coursework, images, sounds, and video owned or licensed by Customer and provided by the Customer through coursework publishing functionality that may be made available by Educative.</p>
                <p><span className="fw-bold">“Documentation” </span> means specifications, help documentation, and other written materials provided to Customer in connection with Customer’s use of Educative Service.</p>
                <p ><span className="fw-bold">“Educative Service”</span>means the web-based interactive learning service that enables Users to view interactive courses, tutorials, and practice sets and all materials provided therewith. </p>
                ...
                <p><span className="fw-bold">“Subscription”</span> means the right to access Educative Service. Subscriptions are available for various types of Users and Plans, as further set forth on the Order Form.</p>
                <p><span className="fw-bold">“Subscription Fee”</span> means the fee for a Subscription to Educative Service, as listed on the Order Form.</p>
                <p><span className="fw-bold">“Users”</span> means users of Educative Service for whom Customer has a valid Subscription. Users may be employees, contractors, job applicants or other individuals.</p>
                <p className="fw-bold">2. Subscription.</p>
                <p className='ms-3'><span className="fw-bold ">2.1 Grant.</span> Subject to Customer’s payment of Subscription Fees, Educative hereby grants to Customer a non-transferable, non-exclusive, limited term, royalty-free license, without the right to sublicense, to access and use Educative Service in accordance with these Terms.</p>
                <p className='ms-3'><span className="fw-bold ">2.2 Administrators; User IDs; Passwords; Service Agreement. </span> Customer must have an assigned administrator to act as a point of contact to Educative. Each User must have a unique user ID. User IDs cannot be shared or transferred. Customer is responsible for maintaining the confidentiality of its user IDs and passwords, and Customer agrees that Educative has no liability with regard to the use or misuse of such user identifications or passwords by third parties. Users must agree to comply with the terms of service set forth at Educative Terms of Service</p>
                <p className='ms-3'><span className="fw-bold ">2.3 Restrictions</span> Except as expressly set forth in Section 2.1, Educative reserves all rights and grants Customer no licenses of any kind hereunder, whether by implication, estoppel, or otherwise. The license set forth in Section 2.1 above does not include any rights to and Customer shall not (a) reproduce, modify, translate or create any derivative work of all or any portion of Educative Service except as permitted within the Educative Service; (b) sell, rent, lease, loan, provide, distribute or otherwise transfer all or any portion of Educative Service; (c) reverse engineer, reverse assemble or otherwise attempt to gain access to the source code of all or any portion of Educative Service; (d) use Educative Service for third-party training, commercial time-sharing or service bureau use; (e) remove, alter, cover or obfuscate any copyright notices, trademark notices or other proprietary rights notices placed or embedded on or in Educative Service; (f) unbundle any components of Educative Service, or third party software; or (g) cause or permit any third party to do any of the foregoing.</p>
                <p ><span className="fw-bold ">3. Data.</span> In connection with Users’ usage of Educative Service, Educative may collect certain data under the terms of the Educative Service privacy policy at Educative Privacy Policy. Educative may use such data to improve Educative Service or other Educative services or to provide usage statistics to current or potential customers. Educative may provide specific, identifiable User information to Customers or their authorized agents as needed to assist such Customers to track User participation (e.g., to track whether a User has successfully completed a course).</p>
